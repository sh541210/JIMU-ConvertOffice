...
//        // 1.等比例缩放
//        scaleNormal("D:\\01.jpg", "D:\\01.TIFF", 3264,2448);
//        // 2.等比例缩放加水印
...
//            writeParameter.setDefaultQuality(0.1f);
//
//            ImageWriteHelper.write(imageWrapper, outStream, ImageFormat.getImageFormat(prefix), writeParameter);
//        } catch (IOException e) {
//            e.printStackTrace();
//        } catch (SimpleImageException e) {
//        } finally {
