...
@Service
public class RabbitOfficeMQServiceImpl implements RabbitOfficeMQService, RabbitTemplate.ConfirmCallback{

    private static final Logger log = LoggerFactory.getLogger(RabbitOfficeMQServiceImpl.class);
     ...
     */
    @Autowired
    public RabbitOfficeMQServiceImpl(RabbitTemplate rabbitTemplate) {
